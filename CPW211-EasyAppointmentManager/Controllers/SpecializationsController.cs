...
namespace CPW211_EasyAppointmentManager.Controllers
{
    public class SpecializationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SpecializationId,Name,Code,Description")] Specialization specialization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpecializationId,Name,Code,Description")] Specialization specialization)
        {
