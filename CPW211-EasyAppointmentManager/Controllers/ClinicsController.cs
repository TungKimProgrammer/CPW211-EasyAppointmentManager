...
namespace CPW211_EasyAppointmentManager.Controllers
{
    public class ClinicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClinicId,ClinicName,ClinicCode,Description,PhoneNumber,Email")] Clinic clinic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClinicId,ClinicName,ClinicCode,Description,PhoneNumber,Email")] Clinic clinic)
        {
