...
namespace CPW211_EasyAppointmentManager.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,Date,AppointmentStatus")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,Date,AppointmentStatus")] Appointment appointment)
        {
